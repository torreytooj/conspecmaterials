...
<form class="shipping_calculator" action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">
	...
	<h4><a href="#" class="shipping-calculator-button"><?php _e( 'Calculate Shipping', GETTEXT_DOMAIN ); ?></a></h4>
	...
	<section class="shipping-calculator-form">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="btn btn-default"><?php _e( 'Update Totals', GETTEXT_DOMAIN ); ?></button></p>
