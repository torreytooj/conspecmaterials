...
function wpmtpv2_display_team($atts, $content = null){
	...
	if($layout == "filterable"){
        ...
        <ul id="wpmtp-source-'. $unique  .'"><li><a href="#" class="wpmtp-all">All</li>';
     	
     	$tax = get_terms("team-category");
     	foreach ($tax as $tax_term) {
     		$return_string .= '<li><a href="#" class="filter-' . $tax_term->slug . '">'. $tax_term->name .'</li>';
     	}
	...
	}wp_reset_query(); // modifited by lpd-themes.com
