...
<form class="variations_form cart" method="post" enctype='multipart/form-data' data-product_id="<?php echo $post->ID; ?>" data-product_variations="<?php echo esc_attr( json_encode( $available_variations ) ) ?>">
	...
	<div class="row">
		...
		<div class="col-md-4 cleat-selection">	
		<?php
		...
		<div class="single_variation_wrap" style="display:none;">
			...
			<div class="variations_button">
				<div class="variations_button_wrap clearfix">
					...
					<button type="submit" class="single_add_to_cart_button btn btn-primary"><span class="halflings shopping-cart halflings-icon white"></span><?php echo $product->single_add_to_cart_text(); ?></button>
				</div>
			</div>
