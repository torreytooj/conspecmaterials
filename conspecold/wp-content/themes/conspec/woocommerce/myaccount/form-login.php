...
<?php endif; ?>
		...
		<form method="post" class="login">
			...
			<p class="form-row">
				...
				<input type="submit" class="btn btn-primary" name="login" value="<?php _e( 'Login', GETTEXT_DOMAIN ); ?>" /> 
	...
	<div class="col-2">
		...
		<form method="post" class="register">
			...
			<p class="form-row">
				...
				<input type="submit" class="btn btn-primary" name="register" value="<?php _e( 'Register', GETTEXT_DOMAIN ); ?>" />
			</p>
